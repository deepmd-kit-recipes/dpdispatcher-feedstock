...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dpdispatcher-feedstock/blob/master/LICENSE.txt)

Summary: 

Development: https://github.com/deepmodeling/dpdispatcher

Documentation: https://github.com/deepmodeling/dpdispatcher
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dpdispatcher-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dpdispatcher` can be installed with:

```
conda install dpdispatcher
```

It is possible to list all of the versions of `dpdispatcher` available on your platform with:
